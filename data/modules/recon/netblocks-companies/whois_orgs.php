...
//Module details
$module_name_here = "Whois Company Harvester";
$module_path_here = "recon/netblocks-companies/whois_orgs";
...
?>
        ...
        <br>
        Description:<br>Uses the ARIN Whois RWS to harvest Companies data from whois queries for the given netblock. Updates the 'companies' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
