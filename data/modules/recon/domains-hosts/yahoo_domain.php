...
//Module details
$module_name_here = "Yahoo Hostname Enumerator";
$module_path_here = "recon/domains-hosts/yahoo_domain";
...
?>
        ...
        <br>
        Description:<br>Harvests hosts from Yahoo.com by using the 'domain' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
