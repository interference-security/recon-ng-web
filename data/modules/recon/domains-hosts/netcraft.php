...
//Module details
$module_name_here = "Netcraft Hostname Enumerator";
$module_path_here = "recon/domains-hosts/netcraft";
...
?>
        ...
        <br>
        Description:<br>Harvests hosts from Netcraft.com. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
