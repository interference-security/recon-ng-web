...
//Module details
$module_name_here = "Google CSE Hostname Enumerator";
$module_path_here = "recon/domains-hosts/google_site_api";
...
?>
        ...
        <br>
        Description:<br>Leverages the Google Custom Search Engine API to harvest hosts using the 'site' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
