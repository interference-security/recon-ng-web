...
//Module details
$module_name_here = "BuiltWith Enumerator";
$module_path_here = "recon/domains-hosts/builtwith";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_showall']) && strlen($_POST['module_option_showall'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
    //Configuration & Functions
    require_once("../../../../includes/config.php");
    require_once("../../../../includes/functions.php");
    $module_showall = urldecode($_POST['module_option_showall']);
    ...
    $set_module_showall = manager_recon("set", array('SHOW_ALL', $module_showall, $sid));
...
?>
        ...
        SHOW_ALL: <input type='text' name='module_option_showall' value="True" class='form-control'><br>
...
?>
        ...
        <br>
        Description:<br>Leverages the BuiltWith API to identify hosts, technologies, and contacts associated with a domain.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
