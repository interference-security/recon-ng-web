...
//Module details
$module_name_here = "Baidu Hostname Enumerator";
$module_path_here = "recon/domains-hosts/baidu_site";
...
?>
        ...
        <br>
        Description:<br>Harvests hosts from Baidu.com by using the 'site' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        $("#runmodule").submit(function(e){    
                ...
                $.post("data/modules/recon/domains-hosts/baidu_site.php", $("#runmodule").serialize(),
                function(data){
