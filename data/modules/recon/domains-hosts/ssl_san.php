...
//Module details
$module_name_here = "SSL SAN Lookup";
$module_path_here = "recon/domains-hosts/ssl_san";
...
?>
        ...
        Author: Zach Grace (@ztgrace) zgrace@403labs.com<br>
        <br>
        Description:<br>Uses the ssltools.com site to obtain the Subject Alternative Names for a domain. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * For an alternative version see https://github.com/403labs/recon-ng_modules.<br>
        <script>
