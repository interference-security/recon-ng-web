...
//Module details
$module_name_here = "Google Hostname Enumerator";
$module_path_here = "recon/domains-hosts/google_site_web";
...
?>
        ...
        <br>
        Description:<br>Harvests hosts from Google.com by using the 'site' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
