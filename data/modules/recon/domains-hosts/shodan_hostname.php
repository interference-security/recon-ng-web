...
//Module details
$module_name_here = "Shodan Hostname Enumerator";
$module_path_here = "recon/domains-hosts/shodan_hostname";
...
?>
        ...
        <br>
        Description:<br>Harvests hosts from the Shodan API by using the 'hostname' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
