...
//Module details
$module_name_here = "Bing Hostname Enumerator";
$module_path_here = "recon/domains-hosts/bing_domain_web";
...
<?php
    ...
    {
?>
        Name: Bing Hostname Enumerator<br>
        Path: modules/recon/domains-hosts/bing_domain_web.py<br>
        Author: Tim Tomes (@LaNMaSteR53)<br>
        <br>
        Description:<br>Harvests hosts from Bing.com by using the 'site' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        $("#runmodule").submit(function(e){    
                ...
                $.post("data/modules/recon/domains-hosts/bing_domain_web.php", $("#runmodule").serialize(),
                function(data){
