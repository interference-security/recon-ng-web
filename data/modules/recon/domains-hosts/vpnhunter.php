...
//Module details
$module_name_here = "VPNHunter Lookup";
$module_path_here = "recon/domains-hosts/vpnhunter";
...
?>
        ...
        Author: Quentin Kaiser (contact[at]quentinkaiser.be)<br>
        <br>
        Description:<br>Checks vpnhunter.com for SSL VPNs, remote accesses, email portals and generic login sites. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
