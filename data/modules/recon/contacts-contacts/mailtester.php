...
//Module details
$module_name_here = "MailTester Email Validator";
$module_path_here = "recon/contacts-contacts/mailtester";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_remove']) && strlen($_POST['module_option_remove'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
    ...
    $set_module_previous = manager_recon("set", array('REMOVE', $module_source, $sid));
...
?>
        ...
        Remove: <input type='text' name='module_option_remove' value="False" class='form-control'><br>
...
?>
        ...
        <br>
        Description:<br>Leverages MailTester.com to validate email addresses.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
