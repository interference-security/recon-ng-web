...
//Module details
$module_name_here = "Flickr Geolocation Search";
$module_path_here = "recon/locations-pushpins/flickr";
...
?>
        ...
        <br>
        Description:<br>Searches Flickr for media in the specified proximity to a location.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * Radius must be greater than zero and less than 32 kilometers.<br>
        <script>
