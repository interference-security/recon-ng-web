...
//Module details
$module_name_here = "YouTube Geolocation Search";
$module_path_here = "recon/locations-pushpins/youtube";
...
if(isset($_POST['module_option_radius']) && strlen($_POST['module_option_radius'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
    ...
    $set_module_limit = manager_recon("set", array('RADIUS', $module_radius, $sid));
...
?>
        ...
        <br>
        Description:<br>Searches the YouTube API for media in the specified proximity to a location.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
