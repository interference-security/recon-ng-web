...
//Module details
$module_name_here = "Twitter Geolocation Search";
$module_path_here = "recon/locations-pushpins/twitter";
...
?>
        ...
        <br>
        Description:<br>Searches Twitter for media in the specified proximity to a location.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
