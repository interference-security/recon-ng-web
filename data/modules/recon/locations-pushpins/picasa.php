...
//Module details
$module_name_here = "Picasa Geolocation Search";
$module_path_here = "recon/locations-pushpins/picasa";
...
?>
        ...
        <br>
        Description:<br>Searches Picasa for media in the specified proximity to a location.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
