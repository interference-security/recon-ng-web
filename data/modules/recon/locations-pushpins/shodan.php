...
//Module details
$module_name_here = "Shodan Geolocation Search";
$module_path_here = "recon/locations-pushpins/shodan";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_limit']) && strlen($_POST['module_option_limit'])>0 && isset($_POST['module_option_radius']) && strlen($_POST['module_option_radius'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
...
?>
        ...
        LIMIT: <input type='text' name='module_option_limit' value="1" class='form-control'><br>
...
?>
        ...
        <br>
        Description:<br>Searches Shodan for media in the specified proximity to a location.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>1</td>
                    <td>yes</td>
                    <td>limit number of api requests per input source (0 = unlimited)</td>
                </tr>
                <tr>
                    <td>RADIUS</td>
                    <td>1</td>
                    <td>yes</td>
                    <td>radius in kilometers</td>
                </tr>
                <tr>
                    <td>SOURCE</td>
                    <td>default</td>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT latitude || ',' || longitude FROM locations WHERE latitude IS NOT NULL AND longitude IS NOT NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
        ...
        <br>
        Comments:<br>
        * Shodan 'geo' searches can take a long time to complete. If receiving connection timeout errors, increase the global SOCKET_TIMEOUT option.<br>
        <script>
