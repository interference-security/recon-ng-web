...
//Module details
$module_name_here = "Whois Data Miner";
$module_path_here = "recon/companies-multi/whois_miner";
...
?>
        ...
        Source: <input type='text' name='module_option_source' class='form-control'>
        <br>
...
?>
        ...
        <br>
        Description:<br>Uses the ARIN Whois RWS to harvest companies, locations, netblocks, and contacts associated with the given company search string. Updates the respective tables with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
            * Wildcard searches are allowed using the "*" character.<br>
            * Validate results of the SEARCH string with these URLs:<br>
                &nbsp;&nbsp;&nbsp;&nbsp;- http://whois.arin.net/rest/orgs;name=<SEARCH><br>
                &nbsp;&nbsp;&nbsp;&nbsp;- http://whois.arin.net/rest/customers;name=<SEARCH><br>
        <script>
