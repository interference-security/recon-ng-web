...
//Module details
$module_name_here = "Github Resource Miner";
$module_path_here = "recon/companies-multi/github_miner";
...
?>
        ...
        <br>
        Description:<br>Uses the Github API to enumerate repositories and member profiles associated with a company search string. Updates the respective tables with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
