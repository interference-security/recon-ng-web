...
//Module details
$module_name_here = "FullContact Contact Enumerator";
$module_path_here = "recon/contacts-profiles/fullcontact";
...
?>
        ...
        Author: Quentin Kaiser (@qkaiser, contact[at]quentinkaiser.be) and Tim Tomes (@LaNMaSteR53)<br>
        <br>
        Description:<br>Harvests contact information and profiles from the fullcontact.com API using email addresses as
  input. Updates the 'contacts' and 'profiles' tables with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
