...
//Module details
$module_name_here = "Jigsaw - Point Usage Statistics Fetcher";
$module_path_here = "recon/companies-contacts/jigsaw/point_usage";
...
?>
        ...
        <br>
        Description:<br>Queries the Jigsaw API for the point usage statistics of the given account.<br>
        <br>
        Options:<br>
        No options available for this module.
        <script>
