...
//Module details
$module_name_here = "LinkedIn Authenticated Contact Enumerator";
$module_path_here = "recon/companies-contacts/linkedin_auth";
...
?>
        ...
        <br>
        Description:<br>Harvests contacts from the LinkedIn.com API using an authenticated connections network. Updates the 'contacts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
