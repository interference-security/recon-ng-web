...
//Module details
$module_name_here = "Jigsaw Authenticated Contact Enumerator";
$module_path_here = "recon/companies-contacts/jigsaw_auth";
...
?>
        ...
        <br>
        Description:<br>Harvests contacts from Data.com using an authenticated user account. Updates the 'contacts' table with the results. Use 'keys' to set your jigsaw username and password before use.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
