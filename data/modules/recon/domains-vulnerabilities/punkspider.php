...
//Module details
$module_name_here = "PunkSPIDER Vulnerabilty Finder";
$module_path_here = "recon/domains-vulnerabilities/punkspider";
...
?>
        ...
        <br>
        Description:<br>Leverages the PunkSPIDER API to search for previosuly discovered vulnerabltiies on hosts within a domain.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
