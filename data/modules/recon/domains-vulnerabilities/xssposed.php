...
//Module details
$module_name_here = "XSSposed Domain Lookup";
$module_path_here = "recon/domains-vulnerabilities/xssposed";
...
?>
        ...
        <br>
        Description:<br>Checks XSSposed.com for XSS records associated with a domain.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
