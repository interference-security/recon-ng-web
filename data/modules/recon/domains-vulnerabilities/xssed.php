...
//Module details
$module_name_here = "XSSed Domain Lookup";
$module_path_here = "recon/domains-vulnerabilities/xssed";
...
?>
        ...
        <br>
        Description:<br>Checks XSSed.com for XSS records associated with a domain and displays the first 20 results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
