...
//Module details
$module_name_here = "Hosts to Locations Data Migrator";
$module_path_here = "recon/hosts-locations/migrate_hosts";
...
?>
        ...
        <br>
        Description:<br>Adds a new location for all the locations stored in the 'hosts' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT latitude, longitude FROM hosts WHERE latitude IS NOT NULL AND longitude IS NOT NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
