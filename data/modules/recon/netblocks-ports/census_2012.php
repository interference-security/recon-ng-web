...
//Module details
$module_name_here = "Internet Census 2012 Lookup";
$module_path_here = "recon/netblocks-ports/census_2012";
...
?>
        ...
        <br>
        Description:<br>Queries the Internet Census 2012 data through Exfiltrated.com to enumerate open ports for a netblock.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * http://exfiltrated.com/querystart.php<br>
        <script>
