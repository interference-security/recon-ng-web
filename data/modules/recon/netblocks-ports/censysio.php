...
//Module details
$module_name_here = "censys.io port lookup by netblock";
$module_path_here = "recon/netblocks-ports/censysio";
...
?>
        ...
        <br>
        Description:<br>Queries censys.io to enumerate open ports for a netblock.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * To enumerate ports for hosts, use the following query as the SOURCE option.<br>
        &nbsp;&nbsp;- SELECT DISTINCT ip_address || '/32' FROM hosts WHERE ip_address IS NOT NULL<br>
        <script>
