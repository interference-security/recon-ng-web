...
//Module details
$module_name_here = "IPInfoDB GeoIP";
$module_path_here = "recon/hosts-hosts/ipinfodb";
...
?>
        ...
        <br>
        Description:<br>Leverages the ipinfodb.com API to geolocate a host by IP address. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
