...
//Module details
$module_name_here = "Hostname Resolver";
$module_path_here = "recon/hosts-hosts/resolve";
...
?>
        ...
        <br>
        Description:<br>Resolves the IP address for a host. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT host FROM hosts WHERE host IS NOT NULL AND ip_address IS NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
