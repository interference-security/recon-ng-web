...
//Module details
$module_name_here = "Bing API IP Neighbor Enumerator";
$module_path_here = "recon/hosts-hosts/bing_ip";
...
?>
        ...
        <br>
        Description:<br>Leverages the Bing API and "ip:" advanced search operator to enumerate other virtual hosts sharing the same IP address. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
