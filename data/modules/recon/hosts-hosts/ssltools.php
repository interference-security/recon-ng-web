...
//Module details
$module_name_here = "SSLTools.com Host Name Lookups";
$module_path_here = "recon/hosts-hosts/ssltools";
...
?>
        ...
        Author: Tim Maletic (borrowing from the ssl_san module by Zach Graces)<br>
        <br>
        Description:<br>Uses the ssltools.com site to obtain host names from a site's SSL certificate metadata to update the 'hosts' table.  Security issues with the certificate trust are pushed to the 'vulnerabilities' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
