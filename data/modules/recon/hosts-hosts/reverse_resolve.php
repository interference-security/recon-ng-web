...
$module_path_here = "recon/hosts-hosts/reverse_resolve";
...
?>
        ...
        Author: John Babio (@3vi1john), @vulp1n3, and Tim Tomes (@LaNMaSteR53)<br>
        <br>
        Description:<br>Conducts a reverse lookup for each IP address to resolve the hostname. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
