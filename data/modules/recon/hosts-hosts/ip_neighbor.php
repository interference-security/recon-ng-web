...
//Module details
$module_name_here = "My-IP-Neighbors.com Lookup";
$module_path_here = "recon/hosts-hosts/ip_neighbor";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_restrict']) && strlen($_POST['module_option_restrict'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
    //Configuration & Functions
    require_once("../../../../includes/config.php");
    require_once("../../../../includes/functions.php");
    $module_restrict = urldecode($_POST['module_option_restrict']);
    ...
    $set_module_restrict = manager_recon("set", array('RESTRICT', $module_restrict, $sid));
...
?>
        ...
        RESTRICT: <input type='text' name='module_option_restrict' value="True" class='form-control'><br>
...
?>
        ...
        <br>
        Description:<br>Checks My-IP-Neighbors.com for virtual hosts on the same server. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>True</td>
                    <td>yes</td>
                    <td>restrict added hosts to current domains</td>
                </tr>
                <tr>
                    <td>SOURCE</td>
                    <td>default</td>
        ...
        <br>
        Comments:<br>
        * This module only stores hosts whose domain matches an entry in the domains table.<br>
        * Knowing what other hosts are hosted on a provider's server can sometimes yield interesting results and help identify additional targets for assessment.<br>
        <script>
