...
//Module details
$module_name_here = "Ports to Hosts Data Migrator";
$module_path_here = "recon/ports-hosts/migrate_ports";
...
?>
        ...
        <br>
        Description:<br>Adds a new host for all the hostnames stored in the 'ports' table.<br>
        <br>
        Options:<br>
