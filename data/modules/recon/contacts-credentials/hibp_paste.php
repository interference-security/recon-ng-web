...
//Module details
$module_name_here = "Have I been pwned? Paste Search";
$module_path_here = "recon/contacts-credentials/hibp_paste";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_download']) && strlen($_POST['module_option_download'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
...
?>
        ...
        <br>
        Description:<br>Leverages the haveibeenpwned.com API to determine if email addresses have been published to various paste sites. Adds compromised email addresses to the 'credentials' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * Paste sites supported: Pastebin, Pastie, or Slexy<br>
        <script>
