...
//Module details
$module_name_here = "PwnedList Validator";
$module_path_here = "recon/contacts-credentials/pwnedlist";
...
?>
        ...
        <br>
        Description:<br>Leverages PwnedList.com to determine if email addresses are associated with leaked credentials. Adds compromised email addresses to the 'credentials' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
