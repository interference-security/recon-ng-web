...
//Module details
$module_name_here = "Linkedin Contact Crawler";
$module_path_here = "recon/profiles-contacts/linkedin";
...
?>
        ...
        Author: Mike Larch and Brian Fehrman<br>
        <br>
        Description:<br>Harvests contact information from linkedin.com by parsing the link(s) given and adding the info to the 'contacts' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
