...
//Module details
$module_name_here = "Dev Diver Repository Activity Examiner";
$module_path_here = "recon/profiles-contacts/dev_diver";
...
?>
        ...
        <br>
        Description:<br>Searches public code repositories for information about a given username.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
