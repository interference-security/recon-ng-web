...
//Module details
$module_name_here = "NameChk.com Username Validator";
$module_path_here = "recon/profiles-profiles/namechk";
...
?>
        ...
        Author: Tim Tomes (@LaNMaSteR53) and thrapt (thrapt@gmail.com)<br>
        <br>
        Description:<br>Leverages NameChk.com to validate the existance of usernames on specific web sites and updates the 'profiles' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
