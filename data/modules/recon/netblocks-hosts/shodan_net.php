...
//Module details
$module_name_here = "Shodan Network Enumerator";
$module_path_here = "recon/netblocks-hosts/shodan_net";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_radius']) && strlen($_POST['module_option_radius'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
...
?>
        ...
        Author: Mike Siegel and Tim Tomes (@LaNMaSteR53)<br>
        <br>
        Description:<br>Harvests hosts from the Shodan API by using the 'net' search operator. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
