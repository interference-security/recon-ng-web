...
//Module details
$module_name_here = "Reverse Resolver";
$module_path_here = "recon/netblocks-hosts/reverse_resolve";
...
?>
        ...
        Author: John Babio (@3vi1john)<br>
        <br>
        Description:<br>Conducts a reverse lookup for each of a netblock's IP addresses to resolve the hostname. Updates the 'hosts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
