...
$module_path_here = "recon/domains-credentials/pwnedlist/leak_lookup";
...
?>
        ...
        <br>
        Description:<br>Queries the local database for information associated with a leak ID. The 'leaks_dump' module must be used to populate the local database before this module will execute successfully.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT leak FROM credentials WHERE leak IS NOT NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
