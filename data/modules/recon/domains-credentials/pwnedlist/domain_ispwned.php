...
//Module details
$module_name_here = "PwnedList - Pwned Domain Statistics Fetcher";
$module_path_here = "recon/domains-credentials/pwnedlist/domain_ispwned";
...
?>
        ...
        <br>
        Description:<br>Queries the PwnedList API for a domain to determine if any associated credentials have been compromised. This module does NOT return any credentials, only a total number of compromised credentials.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
