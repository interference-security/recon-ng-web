...
//Module details
$module_name_here = "PwnedList - API Usage Statistics Fetcher";
$module_path_here = "recon/domains-credentials/pwnedlist/api_usage";
...
?>
        ...
        <br>
        Description:<br>Queries the PwnedList API for account usage statistics.<br>
        <br>
        Options:<br>
        No options available for this module.
        <script>
