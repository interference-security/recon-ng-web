...
//Module details
$module_name_here = "PwnedList - Pwned Domain Credentials Fetcher";
$module_path_here = "recon/domains-credentials/pwnedlist/domain_creds";
...
?>
        ...
        <br>
        Description:<br>Queries the PwnedList API to fetch all credentials for a domain. Updates the 'credentials' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * API Query Cost: 10,000 queries per request plus 1 query for each account returned.<br>
        <script>
