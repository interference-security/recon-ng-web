...
//Module details
$module_name_here = "PwnedList - Account Credentials Fetcher";
$module_path_here = "recon/domains-credentials/pwnedlist/account_creds";
...
?>
        ...
        <br>
        Description:<br>Queries the PwnedList API for credentials associated with the given usernames. Updates the 'credentials' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT username FROM credentials WHERE username IS NOT NULL and password IS NULL ORDER BY username</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
