...
//Module details
$module_name_here = "Reverse Geocoder";
$module_path_here = "recon/locations-locations/reverse_geocode";
...
?>
        ...
        <br>
        Description:<br>Queries the Google Maps API to obtain an address from coordinates.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
