...
//Module details
$module_name_here = "Address Geocoder";
$module_path_here = "recon/locations-locations/geocode";
...
?>
        ...
        Author: Quentin Kaiser (contact@quentinkaiser.be)<br>
        <br>
        Description:<br>Queries the Google Maps API to obtain coordinates for an address. Updates the 'locations' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT street_address FROM locations WHERE street_address IS NOT NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
