...
//Module details
$module_name_here = "SalesMaple Contact Harvester";
$module_path_here = "recon/domains-contacts/salesmaple";
...
?>
        ...
        <br>
        Description:<br>Harvests contacts from the SalesMaple API using domains as input. Updates the 'contacts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
