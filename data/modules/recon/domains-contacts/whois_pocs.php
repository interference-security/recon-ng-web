...
//Module details
$module_name_here = "Whois POC Harvester";
$module_path_here = "recon/domains-contacts/whois_pocs";
...
?>
        ...
        <br>
        Description:<br>Uses the ARIN Whois RWS to harvest POC data from whois queries for the given domain. Updates the 'contacts' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
