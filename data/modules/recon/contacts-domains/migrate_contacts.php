...
//Module details
$module_name_here = "Contacts to Domains Data Migrator";
$module_path_here = "recon/contacts-domains/migrate_contacts";
...
?>
        ...
        <br>
        Description:<br>Adds a new domain for all the hostnames associated with email addresses stored in the 'contacts' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * This modules considers that everything after the first element could contain other hosts besides the current. Therefore, hosts > 2 domains deep will create domains > 2 elements in length.<br>
        <script>
