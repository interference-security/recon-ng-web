...
//Module details
$module_name_here = "Hosts to Domains Data Migrator";
$module_path_here = "recon/hosts-domains/migrate_hosts";
...
?>
        ...
        <br>
        Description:<br>Adds a new domain for all the hostnames stored in the 'hosts' table.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
