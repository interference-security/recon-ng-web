...
//Module details
$module_name_here = "Shodan IP Enumerator";
$module_path_here = "recon/hosts-ports/shodan_ip";
...
?>
        ...
        Author: Tim Tomes (@LaNMaSteR53) and Matt Pluckett (@t3lc0)<br>
        <br>
        Description:<br>Harvests port information from the Shodan API by using the 'ip' search operator. Updates the 'ports' table with the results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
