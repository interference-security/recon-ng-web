...
//Module details
$module_name_here = "Twitter Handles";
$module_path_here = "recon/profiles-profiles/twitter";
...
?>
        ...
        UNTIL: <input type='text' name='module_option_until' value="" class='form-control'><br>
...
?>
        ...
        <br>
        Description:<br>Searches Twitter for users that mentioned, or were mentioned by, the given handle.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>no</td>
                    <td>date-time group in the form YYYY-MM-DD</td>
                </tr>
            </tbody>
        </table>
        <br>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT username FROM profiles WHERE username IS NOT NULL AND resource='Twitter' COLLATE NOCASE</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
        ...
        <br>
        Comments:<br>
        * Twitter limits searchable tweet history to ~3 days.<br>
        <script>
