...
//Module details
$module_name_here = "OSINT HUMINT Profile Collector";
$module_path_here = "recon/profiles-profiles/profiler";
$allowed_actions = ["options", "info"];

//Run module
if(isset($_POST['module_option_sitedb']) && strlen($_POST['module_option_sitedb'])>0 && isset($_POST['module_option_source']) && strlen($_POST['module_option_source'])>0)
{
    //Configuration & Functions
    require_once("../../../../includes/config.php");
    require_once("../../../../includes/functions.php");
    $module_sitedb = urldecode($_POST['module_option_sitedb']);
    ...
    $set_module_sitedb = manager_recon("set", array('SITE_DB', $module_sitedb, $sid));
...
?>
        ...
        SITE_DB: <input type='text' name='module_option_sitedb' value="/usr/share/recon-ng/data/profiler_sites.json" class='form-control'><br>
...
?>
        ...
        Author: Micah Hoffman (@WebBreacher)<br>
        <br>
        Description:<br>Takes each username from the profiles table and searches a variety of web sites for those users.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                <tr>
                    <td>SITE_DB</td>
                    <td>/usr/share/recon-ng/data/profiler_sites.json</td>
                    <td>yes</td>
                    <td>JSON file containing known sites and response codes</td>
                </tr>
                <tr>
                    <td>SOURCE</td>
                    <td>default</td>
        ...
        <table class='table table-condensed'>
            <tr>
                <td>default</td>
                <td>SELECT DISTINCT username FROM profiles WHERE username IS NOT NULL</td>
            </tr>
            <tr>
                <td>&lt;string&gt;</td>
        ...
        <br>
        Comments:<br>
        * Note: The global timeout option may need to be increased to support slower sites.<br>
        * Warning: Using this module behind a filtering proxy may cause false negatives as some of these sites may be blocked.<br>
        <script>
