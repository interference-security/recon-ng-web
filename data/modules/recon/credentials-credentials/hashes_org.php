...
//Module details
$module_name_here = "Hashes.org Hash Lookup";
$module_path_here = "recon/credentials-credentials/hashes_org";
...
?>
        ...
        Author: Tim Tomes (@LaNMaSteR53) and Mike Lisi (@MikeCodesThings)<br>
        <br>
        Description:<br>Uses the Hashes.org API to perform a reverse hash lookup. Updates the 'credentials' table with the positive results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * Hash types supported: MD5, MD4, NTLM, LM, DOUBLEMD5, TRIPLEMD5, MD5SHA1, SHA1, MYSQL5, SHA1MD5, DOUBLESHA1, RIPEMD160<br>
        <script>
