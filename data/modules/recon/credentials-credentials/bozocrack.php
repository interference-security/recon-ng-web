...
//Module details
$module_name_here = "PyBozoCrack Hash Lookup";
$module_path_here = "recon/credentials-credentials/bozocrack";
...
?>
        ...
        <br>
        Description:<br>Searches Google for the value of a hash and tests for a match by hashing every word in the resulting page using all hashing algorithms supported by the 'hashlib' library. Updates the 'credentials' table with the positive results.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
        ...
        <br>
        Comments:<br>
        * Inspired by the PyBozoCrack script: https://github.com/ikkebr/PyBozoCrack<br>
        <script>
