...
//Module details
$module_name_here = "JSON Report Generator";
$module_path_here = "reporting/json";
...
?>
        ...
        FILENAME: <input type='text' name='module_option_filename' value="/root/.recon-ng/workspaces/default/results.json" class='form-control'><br>
...
?>
        ...
        Author: Paul (@PaulWebSec)<br>
        Version: v0.0.1<br>
        <br>
        Description:<br>Creates a JSON report.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                <tr>
                    <td>FILENAME</td>
                    <td>/root/.recon-ng/workspaces/default/results.json</td>
                    <td>yes</td>
