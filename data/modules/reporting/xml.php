...
//Module details
$module_name_here = "XML Report Generator";
$module_path_here = "reporting/xml";
...
?>
        ...
        FILENAME: <input type='text' name='module_option_filename' value="/root/.recon-ng/workspaces/default/results.xml" class='form-control'><br>
        TABLE: <input type='text' name='module_option_table' value="hosts, contacts, credentials" class='form-control'><br>
...
?>
        ...
        Author: Eric Humphries (@e2fsck) and Tim Tomes (@LaNMaSteR53)<br>
        Version: v0.0.2<br>
        <br>
        Description:<br>Creates a XML report.<br>
        <br>
        Options:<br>
        <table class='table'>
            <thead>
            ...
            <tbody>
                <tr>
                    <td>FILENAME</td>
                    <td>/root/.recon-ng/workspaces/default/results.xml</td>
                    <td>yes</td>
                    <td>path and filename for report output</td>
                </tr>
                <tr>
                    <td>TABLE</td>
                    <td>hosts, contacts, credentials</td>
                    <td>yes</td>
                    <td>comma delineated list of tables</td>
                </tr>
            </tbody>
        </table>
        <script>
